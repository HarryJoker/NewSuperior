  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" width="150" label="类型">
        <template slot-scope="scope">
          <span>{{ reviewTypes[scope.row.type] }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="auto" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="类型" prop="type">
          <el-radio v-model="temp.type" label="1">部门政创空间</el-radio>
          <el-radio v-model="temp.type" label="2">街镇政创空间</el-radio>
        </el-form-item>
      </el-form>
