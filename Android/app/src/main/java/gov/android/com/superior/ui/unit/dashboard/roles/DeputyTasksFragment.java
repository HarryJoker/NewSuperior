 ...
 */
public class DeputyTasksFragment extends BaseRecylceFragment {
    ...
    private void requestAllLeadersSummary() {
        OkGo.<List<JSONObject>>get(HttpUrl.EADERS_SUMMARY + "/" + category + "/" + User.getInstance().getUnitId() + "/" +  DateUtil.getNowMonth()).tag(this).execute(getJsonArrayCallback(HttpUrl.EADERS_SUMMARY));
    }
