package gov.android.com.superior.view.searchview;
...
public class SearchView extends LinearLayout {
    ...
    private gov.android.com.superior.view.searchview.bCallBack bCallBack; // 返回按键回调接口
    ...
    private void init(){
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tempName = tempName.replaceAll(reg, "");
                try {
...
//                Toast.makeText(context, "返回到上一页", Toast.LENGTH_SHORT).show();
     ...
     * 点击返回后的操作，用于接口回调
     */
    public void setOnClickBack(gov.android.com.superior.view.searchview.bCallBack bCallBack){
