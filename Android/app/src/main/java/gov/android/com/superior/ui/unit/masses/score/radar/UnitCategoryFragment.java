 ...
 */
public class UnitCategoryFragment extends BaseContentFragment {
    ...
    public void onFindViews(View rootView) {
        ...
        tvCategory = rootView.findViewById(R.id.tv_category);
    ...
    public void onInitViews() {
        ...
        tvCategory.setText(Config.categoryTitles.get(category) + "业绩考评");
    }

    @Override
    public int getLayoutRes() {
        return R.layout.fragment_unit_category;
    }
    ...
    private void requestUnitScore() {
        showLoading();
        OkGo.<JSONObject>post(HttpUrl.UNIT_CATEGORY_SCORE + "/" + category + "/" + unitId).tag(this).execute(getJsonObjectCallback(HttpUrl.UNIT_SCORE));
    }
...
//            put("9", new Integer[]{55, 55, 55});
    ...
    private void makeChatData(JSONObject data) {
        ...
        entries.add(new RadarEntry(data.getFloatValue("11") - randomNum()));
        entries.add(new RadarEntry(data.getFloatValue("50") - randomNum()));
        entries.add(new RadarEntry(data.getFloatValue("52") - randomNum()));
        entries.add(new RadarEntry(data.getFloatValue("72") - randomNum()));
        entries.add(new RadarEntry(data.getFloatValue("74") - randomNum()));
        RadarDataSet set = new RadarDataSet(entries, Config.categoryTitles.get(category));
        set.setColor(Color.rgb(109, 168, 255));
        set.setFillColor(Color.rgb(109, 168, 255));
