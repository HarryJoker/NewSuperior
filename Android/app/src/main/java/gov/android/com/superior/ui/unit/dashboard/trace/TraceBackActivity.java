...
public class TraceBackActivity extends BaseToolBarActivity {
    ...
    public int getLayoutRes() {
        return R.layout.activity_trace_back;
    }

    @Override
    protected void onBarTitle(TextView barTitle) {
        barTitle.setText("退回重报");
    }
    ...
    protected void onJsonObjectCallBack(String action, JSONObject data) {
        ...
        Toast.makeText(this, "已退回", Toast.LENGTH_SHORT).show();
        setResult(RESULT_OK);
        finish();
    }
}
