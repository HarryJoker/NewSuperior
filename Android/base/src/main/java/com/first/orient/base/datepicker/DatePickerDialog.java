...
public class DatePickerDialog extends AlertDialog implements OnClickListener,
    ...
    DatePickerDialog(Context context,
        ...
        View view = inflater.inflate(R.layout.lib_date_picker_dialog_container, null);
        setView(view);
        ...
        setOnShowListener(new OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                setButtonStyle(getButton(BUTTON_NEGATIVE));
                setButtonStyle(getButton(BUTTON_POSITIVE));
            }
        });
    }
    ...
    private void setButtonStyle(Button button) {
        if (button != null) {
            ...
            button.setTextSize(DpUtils.getSmallestScreenDimen(getContext(), R.dimen.sp_18));
        }
    }
