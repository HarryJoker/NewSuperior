package com.first.orient.base.datepicker;
...
public class DatePicker extends FrameLayout {
    ...
    DatePicker(ViewGroup root, int numberPickerStyle) {
        ...
        inflater.inflate(R.layout.lib_date_picker_container, this, true);
        ...
        // day
        mDaySpinner = (NumberPicker) inflater.inflate(R.layout.lib_number_picker_day_month, mPickerContainer, false);
//        mDaySpinner.setId(R.id.day);
        ...
        // month
        mMonthSpinner = (NumberPicker) inflater.inflate(R.layout.lib_number_picker_day_month,
...
//        mMonthSpinner.setId(R.id.month);
        ...
        // year
        mYearSpinner = (NumberPicker) inflater.inflate(R.layout.lib_number_picker_year, mPickerContainer, false);
//        mYearSpinner.setId(R.id.year);
    ...
    void init(int year, int monthOfYear, int dayOfMonth, boolean isDayShown, OnDateChangedListener onDateChangedListener) {
