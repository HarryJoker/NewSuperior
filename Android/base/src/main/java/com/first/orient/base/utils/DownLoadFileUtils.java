...
public class DownLoadFileUtils {
     ...
     */
    public static void downloadFile(Context context, String fileUrl, String destFileDir, String destFileName, String mFileRelativeUrl, final DownloadListener listener){
        ...
        OkGo.<File>get(fileUrl).tag(context).execute(new FileCallback(destFileDir,mDestFileName) { //文件下载时指定下载的路径以及下载的文件的名称
            ...
            public void onSuccess(com.lzy.okgo.model.Response<File> response) {
                JokerLog.e("下载文件成功"+"DDDDD"+response.body().length());
                mBasePath = response.body().getAbsolutePath();

                if (listener != null) {
                    listener.onSuccess(mBasePath);
                }
            }
...
//                SPUtils.getInstance().put("localPath",mBasePath);
            ...
            public void onError(com.lzy.okgo.model.Response<File> response) {
                ...
                JokerLog.e("下载文件出错"+"DDDDD"+response.message());
                if (listener != null) {
                    listener.onFalie();
                }
            ...
            public void downloadProgress(Progress progress) {
                ...
                JokerLog.e("文件下载的进度"+"DDDDD"+dLProgress);
                if (listener != null) {
                    listener.onProgresss(dLProgress);
                }
            }
        });
    }
    ...
    public interface DownloadListener {
        ...
        void onFinished();
        void onProgresss(float progress);
        void onFalie();
    }
}