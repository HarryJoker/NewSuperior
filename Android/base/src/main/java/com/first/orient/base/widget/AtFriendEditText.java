...
public class AtFriendEditText extends TopicEditText {

    public AtFriendEditText(Context context) {
        super(context);
    }

    public AtFriendEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AtFriendEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void makeSpan(Spannable sps, UnSpanText unSpanText, String userId) {
        ...
        sps.setSpan(new ForegroundColorSpan(getSpanColor()), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        Log.d("onTextChanged", "s:" + text + ", start:" + start + ", before:" + lengthBefore + ", after:" + lengthAfter);
