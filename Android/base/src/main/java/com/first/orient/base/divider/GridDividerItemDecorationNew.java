package com.first.orient.base.divider;

/**
 * Author: harryjoker
 * Created on: 2020-03-02 17:12
 * Description:
 */
...
public class GridDividerItemDecorationNew extends RecyclerView.ItemDecoration {
    private Paint mPaint;
    private int mDividerWidth,mDividerHeight;

    public GridDividerItemDecorationNew(int height) {
    ...
    public GridDividerItemDecorationNew(int height, @ColorInt int color) {
        mDividerWidth = height;
        mDividerHeight = height;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    public GridDividerItemDecorationNew(int width, int height, @ColorInt int color) {
        mDividerWidth = width;
        mDividerHeight = height;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
