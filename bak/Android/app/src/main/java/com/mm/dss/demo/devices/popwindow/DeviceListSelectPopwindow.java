...
public class DeviceListSelectPopwindow extends BasePopwindow implements OnClickListener {
	...
	private void initPopWindow() {
		popwindowView = LayoutInflater.from(context).inflate(R.layout.dss_device_list_select_layout, null);
	...
	private void initAreaHeaderView(){
		LinearLayout header = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.dss_device_area_list_header_item, null);
