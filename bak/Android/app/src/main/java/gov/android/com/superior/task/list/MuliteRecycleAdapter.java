...
//    private void updateRankPosition(int rank, int position) {
//        if (rank < 0 || rank > mRankKeys.size()) return;
//        Integer[] positions = new Integer[mRankKeys.size()];
//        for (int n = 0; n < mRankKeys.size(); n++) {
//            positions[n] = -1;
//            if (n < mRankPositions.size()) {
//                int rankPos = mRankPositions.get(n);
//                positions[n] = rankPos;
//
//                if (n == rank) {
...
//        }
//
//        List<Integer> tmp = Arrays.asList(positions);
