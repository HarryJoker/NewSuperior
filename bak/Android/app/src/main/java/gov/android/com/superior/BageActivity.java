...
import gov.android.com.superior.bage.BadgeNumberManager;
import gov.android.com.superior.bage.BadgeNumberManagerXiaoMi;
import gov.android.com.superior.bage.MobileBrand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSetBadge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ShortcutBadger.applyCount(BageActivity.this, 2); //for 1.1.4+

                //设置应用在桌面上显示的角标
//                if (!Build.MANUFACTURER.equalsIgnoreCase(MobileBrand.XIAOMI)) {
//                    BadgeNumberManager.from(BageActivity.this).setBadgeNumber(10);
//                    Toast.makeText(BageActivity.this, "设置桌面角标成功", Toast.LENGTH_SHORT).show();
//                } else {
...
//                }
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Build.MANUFACTURER.equalsIgnoreCase(MobileBrand.XIAOMI)) {
                    BadgeNumberManager.from(BageActivity.this).setBadgeNumber(0);
                    Toast.makeText(BageActivity.this, "清除桌面角标成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void setXiaomiBadgeNumber() {
        NotificationManager notificationManager = (NotificationManager) BageActivity.this.getSystemService(Context.NOTIFICATION_SERVICE);
        Notification notification = new NotificationCompat.Builder(BageActivity.this)
                .setSmallIcon(BageActivity.this.getApplicationInfo().icon)
