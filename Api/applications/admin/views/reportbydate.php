    ...
    <section class="main-content-wrapper">
        ...
        <form id="myForm" class="form-horizontal form-border" action=<?php echo site_url("report").'/'.$category.'/0'?> method="post" >
                <div class="form-group ">
                    <label class="col-sm-2"><?php echo $title ?></label>
                    <label class="col-sm-1">开始日期</label>
                    <input class="col-sm-2" required="" id="startDate" name="startDate" type="date" value="<?=$startDate ?>"/>
                    <label class="col-sm-1">截止日期</label>
                    <input class="col-sm-2" required="" id="endDate" name="endDate" type="date" value="<?=$endDate ?>"/>
